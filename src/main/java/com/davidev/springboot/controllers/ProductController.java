package com.davidev.springboot.controllers;

import com.davidev.springboot.dtos.ProductRecordDto;
import com.davidev.springboot.models.ProductModel;
import com.davidev.springboot.repositories.ProductRepository;
...
public class ProductController {
    ...
    public ResponseEntity<List<ProductModel>> gettAllProducts() {
        ...
        if (!productModelList.isEmpty()){
            for (ProductModel product : productModelList){
                ...
                product.add(linkTo(methodOn(ProductController.class).getOneProduct(uuid)).withSelfRel());
            }
        }
    ...
    public ResponseEntity<Object> getOneProduct(@PathVariable(value = "id") UUID uuid) {
        ...
        product.get().add(linkTo(methodOn(ProductController.class).gettAllProducts()).withRel("Products List"));
